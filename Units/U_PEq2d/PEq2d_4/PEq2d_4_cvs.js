// drawCvs1 for PE2d_4   06/15/2017
function drawCvs1()
{
	var cid=  "layer1";
	...
	cDrawDot(cid,x0+35,y0+42,4,"black");
	cDrawLine(cid,x0,y0,x0,y0+46,"silver",10,"butt");
	cDrawLine(cid,x0-45,y0+50,x0+45,y0+50,"silver",12,"round");
	cDrawLine(cid,x0-90,y0+59,x0+90,y0+59,"gray",6,"round");	

	cDrawDot(cid,x0,y0,12,"silver");
